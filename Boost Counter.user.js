...
'use strict';
console.log("%c+", 'font-size: 1px; padding: 150px 150px; line-height: 0; background: url("https://i.imgur.com/hMLVsFO.gif"); background-size: 300px 300px; color: transparent;') //Totally did not steal this idea from xPaw
